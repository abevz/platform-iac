...
# k8s-master   Ready    control-plane   5m    v1.31.0   192.0.2.200
# k8s-worker1  Ready    <none>          3m    v1.31.0   192.0.2.201
# k8s-worker2  Ready    <none>          3m    v1.31.0   192.0.2.202
...
kubectl run test-pod --image=harbor.example.com/library/nginx:latest \
...
docker login harbor.example.com -u robot$k8s-pull -p YOUR_TOKEN
