...
# Test specific vhost
curl -H "Host: harbor.example.com" https://your-proxy-ip/
...
|---------|--------|----------|------|
| GitLab | gitlab.example.com | 192.0.2.104:80 | 443 |
| Harbor | harbor.example.com | 192.0.2.103:80 | 443 |
| Wiki.js | wiki.example.com | 192.0.2.5:3000 | 443 |
| PlantUML | plantuml.example.com | 192.0.2.5:18080 | 443 |
| MinIO S3 | s3.example.com | minioserver:9000 | 443 |
| MinIO Console | minio.example.com | minioserver:9001 | 443 |
| Proxmox | pve.example.com | 192.0.2.101:8006 | 443 |
| Kubernetes | *.example.com | 192.0.2.200:443 | 443 |

### TCP/Stream Services

| Service | Port | Upstream |
|---------|------|----------|
| Proxmox SSH | 2222 | 192.0.2.101:22 |
| GitLab SSH | 2223 | 192.0.2.104:22 |
| Kubernetes Ingress | 443 | 192.0.2.200:443 |
...
curl -v http://192.0.2.104:80
telnet 192.0.2.104 80

# Check firewall rules
iptables -L -n

# Verify upstream service is running
ssh user@192.0.2.104 'systemctl status gitlab'
```
