...
# ingress-nginx-controller             LoadBalancer   10.96.45.123    192.0.2.200    80:31234/TCP,443:32345/TCP
...
Test:
```bash
curl -H "Host: app.example.com" http://192.0.2.200/
```
