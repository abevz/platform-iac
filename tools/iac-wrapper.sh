...
load_tofu_secrets_to_temp_file() {
  ...
  local PROXMOX_DIRECT_IP="192.0.2.101"
  local PROXMOX_DIRECT_API_URL="https://192.0.2.101:8006" # <-- ИСПРАВЛЕНИЕ ЗДЕСЬ
  ...
  local PROXMOX_PROXY_SSH_ADDR="homelab.example.com"
