...
print_usage() {
  ...
  echo "    [limit_target] (опционально) - ограничить выполнение (напр. 'k8s_control_plane' или '192.0.2.12')."
  echo ""
  ...
  echo "    на *конкретную цель* (напр. 'k8s_control_plane' или '192.0.2.12')."
  echo ""
