...
> This repository contains example IP addresses (`10.10.10.x`) and domain names (`example.com`) for demonstration purposes.
> **Before deployment:**
...
3. **Pi-hole:** A running Pi-hole instance (e.g., at `192.0.2.100`) for internal DNS.
4. **Harbor:** A running Harbor instance (e.g., at `harbor.example.com`) for container proxy caching.
